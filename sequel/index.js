...
var Sequel = module.exports = function(schema, options) {
  ...
  // enable the logging of queries generated by the class
  this.enableQueryLogging = options && utils.object.hasOwnProperty(options, 'enableQueryLogging') ? options.enableQueryLogging : true;
